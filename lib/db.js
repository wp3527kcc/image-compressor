...
const MIGRATION_STATEMENTS = [
  ...
  `ALTER TABLE auth_media_history
    ADD COLUMN IF NOT EXISTS output_filename TEXT NULL`,
  `ALTER TABLE auth_media_history
    ADD COLUMN IF NOT EXISTS output_format TEXT NULL`,
  `ALTER TABLE auth_media_history
    ADD COLUMN IF NOT EXISTS source_pathname TEXT NULL`,
  `ALTER TABLE auth_media_history
    ADD COLUMN IF NOT EXISTS result_pathname TEXT NULL`,
  `ALTER TABLE auth_media_history
    ADD COLUMN IF NOT EXISTS source_url TEXT NULL`,
  `ALTER TABLE auth_media_history
    ADD COLUMN IF NOT EXISTS result_url TEXT NULL`,
  `ALTER TABLE auth_media_history
    ADD COLUMN IF NOT EXISTS compression_ratio DOUBLE PRECISION NULL`,
  `ALTER TABLE auth_media_history
    ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ NOT NULL DEFAULT NOW()`,
  `DO $$
  BEGIN
